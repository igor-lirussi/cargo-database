...
<html>
  ...
  <body>
    ...
    ?>
    <?php
      $movimentazione=$_GET['codMov'];
      $merce=$_GET['codMer'];
      $sql="INSERT INTO compiere(Merce_idMerce, Movimentazioni_idMov)
            VALUES ( $merce, $movimentazione)";
  ...
  <br>
   <br>
   <a href="GDI_Compiere.html"> Nuovo inserimento nella correlazione </a> <br>
  </div>
  <div id="content2">
