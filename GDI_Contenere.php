...
<html>
  ...
  <body>
    ...
    ?>
    <?php
      $deposito=$_GET['codDep'];
      $merce=$_GET['codMer'];
      $sql="INSERT INTO contenere(Merce_idMerce, Deposito_idDeposito)
            VALUES ( $merce, $deposito)";
  ...
  <br>
   <br>
   <a href="GDI_Contenere.html"> Nuovo inserimento nella correlazione </a> <br>
  </div>
  <div id="content2">
