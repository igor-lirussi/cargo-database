...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $badge=$_GET['badge'];
      $tipo = "Magazziniere";
      $sql="INSERT INTO Persona(CodFiscale, Nome, Cognome, Citta, Via, Numero,Tipo, Badge)
            VALUES ( '$cf', '$nome', '$cognome', '$citta', '$via', '$numero', '$tipo', '$badge')";
  ...
  $conn->close();
   ...
   <br>
   <br>
   <a href="GDI_Mag.html"> Nuovo inserimento nella tabella </a> <br>
  </div>
  <div id="content2">
