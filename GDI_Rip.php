...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $data=$_GET['data'];
      $cfMecc=$_GET['cfMecc'];
      $nomeOff=$_GET['nomeOff'];
        $sql="INSERT INTO Riparazione(Tipo, Data, Persona_CodFiscale, Officina_Nome_Commerciale)
            VALUES ( '$tipo', '$data', '$cfMecc', '$nomeOff')";
  ...
  $conn->close();
   ...
   <br>
   <br>
   <a href="GDI_Rip.html"> Nuovo inserimento nella tabella </a> <br>
  </div>
  <div id="content2">
